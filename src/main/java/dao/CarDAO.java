...
import com.example.farm_vehicle_crud_part1.Car;
...
public class CarDAO {
    private String url = "jdbc:mysql://localhost:3306/db_auto";
    private String dbUser = "root";
    private String dbPassword = "29986929";

    private static final String INSERT_CARS_SQL = "INSERT INTO auto" + "  (manufacturer, model, year, price) VALUES "
            + " (?, ?, ?, ?);";

    private static final String SELECT_CAR_BY_ID = "select id, manufacturer, model, year, price from auto where id =?";
    private static final String SELECT_ALL_CARS = "select * from auto";
    private static final String DELETE_CARS_SQL = "delete from auto where id = ?;";
    private static final String UPDATE_CARS_SQL = "update auto set manufacturer = ?,model = ?, year =?, price =? where id = ?;";
...
//    }
    ...
    public boolean updateCar(Car car) throws SQLException {
        ...
        try (Connection connection = getConnection();
            ...
            statement.setString(1, car.getNameCar());
